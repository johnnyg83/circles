...
async function getCurrentUserInterests(){
    var result = await fetch('api/user/data?' + new URLSearchParams(
        {
            id: 'CURRENT'
        }), 
        {
...
async function addCurrentUserInterest(interest){
    var result = await fetch('api/user/addinterest?' + new URLSearchParams(
        {
            id: 'CURRENT',
            interest: interest
        }), 
